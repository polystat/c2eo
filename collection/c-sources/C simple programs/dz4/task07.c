...
int main(int argc, char *argv[])
{
    ...
    char* name = 0;
    double t = 0;
    if (!((argc == 7 || argc == 8) && sscanf(argv[1], "%d", &i) == 1 && sscanf(argv[2], "%d", &j) == 1 
	&& sscanf(argv[3], "%d", &n) == 1 && sscanf(argv[4], "%d", &m) == 1 && sscanf(argv[5], "%d", &p) == 1 
    && sscanf(argv[6], "%d", &k) == 1  && k >= 0 && k <= 4 && i > 0 && i <= n && j > 0 && j <= n )){
