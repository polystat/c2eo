...
__attribute__((unused)) void TraceOutBinaryOperator(clang::BinaryOperatorKind kind);

__attribute__((unused)) void TraceOutIntegerLiteral(llvm::APInt &v, bool is_signed);
