...
static const long long x_8, x_9 = -9223372036854775807, x_10 = -922337220368, x_11 = 0, x_12 = 1, x_13 = 72036854775807, x_14 = 9223372036854775807;
int main() {
    long long i = 0;
    i = 1;
    printf("%lld\n", i);
